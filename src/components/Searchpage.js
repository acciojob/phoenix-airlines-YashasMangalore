    ...
    <div>
      ...
      {search && (
        <div>
          ...
          <div>
            <p>
              1.Air India AI-275 Departure : 12:00 Journey Time : 1 Hr 25 Min
              Rs.3,600{" "}
              <button
                onClick={() => {
                  dispatch(
          ...
          <div>
            <p>
              2.Kingfisher Airlines KF-183 Departure : 04:00 Journey Time : 1 hr
              Rs.3,000{" "}
              <button
                onClick={() => {
                  dispatch(
                    storeJourneydata({
                      ...reduxdata,
                      flightname: "Kingfisher Airlines KF-183",
                    })
                  );
                  navigate("/flight-booking");
                }}
